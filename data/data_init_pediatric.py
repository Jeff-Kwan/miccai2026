...
Example:
  python download_echonet.py --dest ./echonetpediatric
"""
...
# UPDATED: EchoNet Pediatric container SAS URL
SOURCE_SAS_URL = (
    "https://aimistanforddatasets01.blob.core.windows.net/echonetpediatric"
    "?sv=2019-02-02&sr=c&sig=60yRb5RspR88CXPk6Wags9sdDg6oSPliezUt8YjzYQE%3D"
    "&st=2026-02-23T10%3A21%3A12Z&se=2026-03-25T10%3A26%3A12Z&sp=rl"
)
...
def main():
    ...
    ap.add_argument("--dest", default="./data", help="Destination folder")
